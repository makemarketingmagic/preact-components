...
})(['display:grid;grid-template-columns:', ';width:100%;overflow:hidden;'], function (props) {
...
})(['cursor:', ';font-family:\'Montserrat\';font-style:normal;font-weight:600;line-height:18px;font-size:14px;border-bottom:', ';padding-bottom:7px;padding-right:16px;color:#323232;display:flex;align-items:center;'], function (props) {
...
})(['height:48px;min-width:0;border-bottom:1px solid rgba(32,32,32,0.1);font-style:normal;font-weight:normal;line-height:18px;font-size:14px;padding-right:16px;display:flex;align-items:center;position:relative;color:#888888;', ' ', ''], function (props) {
    return props.selected ? '\n        &:before {\n            background-color: ' + props.selectedBackground + ';\n        }\n    ' : '';
}, function (props) {
    return props.hasExpandingSection ? '\n        cursor: pointer;\n    \n        & span {\n            z-index: 2;\n        }\n        &:before {\n            content: "";\n            position: absolute;\n            top: 0;\n            bottom: 0;\n            right: -1000%;\n            left: -1000%;\n            z-index: 1;\n        }\n        \n        &:nth-child(' + props.cols + 'n+' + props.cols + ')::after {\n            bottom: -1px;\n        right: 0;\n        left: -1000%;\n        height: 1px;\n        z-index: 3;\n        width: auto;\n        top: auto;\n        background-color: #fff;\n    }\n    \n    &:hover::before {\n        background-color: ' + props.selectedBackground + ';\n    }\n    ' : '';
}),
...
var Table = function (_Component) {
    ...
    Table.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            _props$spanStyle = _props.spanStyle,
            spanStyle = _props$spanStyle === undefined ? {} : _props$spanStyle,
