...
})(['cursor:pointer;font-family:\'Montserrat\';font-style:normal;font-weight:600;line-height:18px;font-size:14px;border-bottom:', ';padding-bottom:7px;color:#323232;display:flex;align-items:center;'], function (props) {
...
})(['height:48px;border-bottom:1px solid rgba(32,32,32,0.1);font-style:normal;font-weight:normal;line-height:18px;font-size:14px;display:flex;align-items:center;color:#888888;background-color:', ';'], function (props) {
    return props.selected ? '#F2F8FA' : '#fff';
}),
...
})(['grid-column:1 / 7;background-color:', ';'], function (props) {
    return props.selected ? '#F2F8FA' : '#fff';
});
            ...
            headersArray.map(function (_ref) {
                ...
                return (0, _preact.h)(Heading, {
                    onClick: function onClick() {
                        return setOrderBy(key, orderBy !== key ? true : !direction);
                    },
                    text: value,
                    field: key,
                    ordered: orderBy === key,
            ...
            data.map(function (val) {
                return [headersArray.map(function (_ref2) {
                    ...
                    return (0, _preact.h)(
                        ...
                        renderers[key] ? renderers[key](val[key]) : val[key]
                    );
                }), hasExpandingSection && ExpandingSection && selected === val.id ? (0, _preact.h)(
                    ExpandableContainer,
                    { selected: selected === val.id },
                    (0, _preact.createElement)(ExpandingSection, _extends({ data: val }, _this2.props.expandingSectionProps))
                ) : null];
            })
        );
    };
