...
})(['display:flex;visibility:', ';opacity:', ';background-color:rgba(255,255,255,0.85);position:fixed;top:0;left:0;right:0;bottom:0;align-items:center;justify-content:center;z-index:1;transition:opacity ', 'ms ease-in-out;& > *{transition:all ', 'ms ease-in-out;transform:scale(', ');}'], function (props) {
