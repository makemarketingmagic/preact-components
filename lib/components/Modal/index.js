...
})(['z-index:3;background-color:', ';box-shadow:0 8px 16px 0 ', ',0 1px 2px 1px ', ';border-radius:4px;max-width:800px;width:100%;color:#323232;margin:0 auto;display:flex;flex-direction:column;justify-content:center;'], _scMixins.colors.white, (0, _polished.transparentize)(0.92, _scMixins.colors.black), (0, _polished.transparentize)(0.84, _scMixins.colors.black)),
    Title = _styledComponents2.default.div.withConfig({
    displayName: 'Modal__Title'
})(['color:', ';padding-top:28px;padding-bottom:20px;margin-bottom:32px;text-align:center;font-family:\'Montserrat\';font-style:normal;font-weight:normal;line-height:22px;font-size:18px;border-bottom:1px solid rgba(32,32,32,0.1);'], _scMixins.colors.red),
