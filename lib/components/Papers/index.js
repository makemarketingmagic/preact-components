...
})(['width:100%;display:flex;flex-direction:column;position:', ';', ';', ' transition:transform ', 'ms ease-in-out,z-index 1ms ease-in-out ', 'ms;top:0;opacity:', ';transform:', ';'], function (props) {
