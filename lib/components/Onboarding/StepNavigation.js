...
})(['height:160px;width:100%;background-color:', ';padding:16px 64px;display:flex;flex-direction:row;align-items:center;justify-content:center;'], _scMixins.colors.white),
