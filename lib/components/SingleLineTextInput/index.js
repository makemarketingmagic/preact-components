...
})(['color:', ';border:none;width:100%;font-size:14px;outline:none;padding:8px 16px;&::placeholder{color:', ';}&:disabled{background-color:rgba(136,165,173,0.2);}'], _scMixins.colors.text, _scMixins.colors.grey);
...
var SingleLineTextInput = function (_Component) {
    ...
    SingleLineTextInput.prototype.renderValidIcon = function renderValidIcon() {
        var _ref;

        var Icon = this.state.valid ? _TickIcon2.default : _CrossIcon2.default;
        return (0, _preact.h)(
            'div',
            { stlye: (_ref = { marginRight: 4 }, _ref['marginRight'] = 4, _ref.display = 'flex', _ref) },
            (0, _preact.h)(Icon, { width: 14, height: 10, color: this.state.valid ? _scMixins.colors.green : _scMixins.colors.red })
        );
    };
    ...
    SingleLineTextInput.prototype.render = function render() {
        var _props = this.props,
            ...
            value = _props.value,
            _props$validation = _props.validation,
            validation = _props$validation === undefined ? false : _props$validation;
        ...
        return (0, _preact.h)(
            ...
            iconLeft && (0, _preact.h)(
                'div',
                { style: { marginLeft: 4, marginRight: 4, display: 'flex' } },
                (0, _preact.h)(Icon, null)
            ),
            (0, _preact.h)(Input, { onChange: this.handleChange, placeholder: placeholder, type: type, value: value, disabled: disabled }),
