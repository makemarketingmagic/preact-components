...
})(['margin-top:16px;margin-bottom:16px;padding:0 64px;', ''], _scMixins.media.mobile(_templateObject));
...
var VisitRow = (0, _styledComponents2.default)(VisitHeader).withConfig({
    displayName: 'RecentVisits__VisitRow'
})(['color:#88A5AD;']);
