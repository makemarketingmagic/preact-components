...
var RecommendedLead = function (_Component) {
    ...
    RecommendedLead.prototype.render = function render() {
        ...
        data = data.reduce(function (acc, val) {
            acc.push(Object.assign({ props: { data: val, actions: actions } }, { component: RecommendedLeadComponent }));
            return acc;
        }, []);
        return (0, _preact.h)(
            _index4.default,
            { buttonText: buttonText },
            (0, _preact.h)(_Papers2.default, { pages: data })
        );
    };
...
var RecommendedLeadComponent = exports.RecommendedLeadComponent = function (_Component2) {
    ...
    RecommendedLeadComponent.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            ...
            (0, _preact.h)(_RecommendedLeadButtons2.default, { done: actions.done, nextPage: nextPage, remindMe: actions.remindMe })
        );
    };
