...
var RecommendedLeadComponent = exports.RecommendedLeadComponent = function (_Component2) {
    ...
    RecommendedLeadComponent.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            'div',
            null,
            data.tooltip ? (0, _preact.h)(_index2.default, {
                color: 'orange',
            ...
            data.company ? (0, _preact.h)(_CompanyDetails2.default, {
            ...
            data.company && data.company.visits ? (0, _preact.h)(_RecentVisits2.default, {
                translations: {
            ...
            data.contact ? (0, _preact.h)(_CompanyContact2.default, {
