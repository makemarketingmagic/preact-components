...
var RecommendedLead = function (_Component) {
    ...
    RecommendedLead.prototype.render = function render() {
        return (0, _preact.h)(_Papers2.default, { pages: [{ component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }, { component: RecommendedLeadComponent, props: {} }] });
    };
    ...
    RecommendedLeadComponent.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            ...
            (0, _preact.h)(
                'div',
                null,
                (0, _preact.h)(_SingleLineTextInput2.default, { placeholder: 'Email Address', validation: 'email', showIcon: true })
            ),
            (0, _preact.h)(
                'div',
                null,
                (0, _preact.h)(_SingleLineTextInput2.default, { placeholder: 'Netherlands Phone Number', validation: 'phone-nl' })
            ),
            (0, _preact.h)(
                'div',
                null,
                (0, _preact.h)(_SingleLineTextInput2.default, { placeholder: 'Custom Validation', validation: /^\d.+?\w$/ig })
            ),
            (0, _preact.h)(
                'div',
                null,
                (0, _preact.h)(_Checkboxes2.default, { options: [{ label: 'Option 1', data: 'test0' }, { label: 'Option 2', data: 'test1', selected: true }] })
            ),
