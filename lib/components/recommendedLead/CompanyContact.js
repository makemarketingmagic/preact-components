...
})(['margin-top:16;padding:32px 64px;background-color:#F2F8FA;', ''], _scMixins2.default.media.mobile(_templateObject));

var ContactMethods = _styledComponents2.default.div.withConfig({
    displayName: 'CompanyContact__ContactMethods'
})(['display:flex;flex-direction:row;', ''], _scMixins2.default.media.mobile(_templateObject2));

var ContactTip = _styledComponents2.default.div.withConfig({
    displayName: 'CompanyContact__ContactTip'
})(['margin-top:24px;color:#88A5AD;span:{color:#323232;}', ''], _scMixins2.default.media.mobile(_templateObject3));
