        ...
        return (0, _preact.h)(
            ...
            (0, _preact.h)(
                ...
                contactMethods.map(function (method) {
                    return method.value instanceof Array ? method.value.map(function (methodValue) {
                        return methodValue ? (0, _preact.h)(_ContactMethod2.default, { type: method.type, value: methodValue }) : null;
                    }) : method.value ? (0, _preact.h)(_ContactMethod2.default, { type: method.type, value: method.value }) : null;
                })
            ),
            (0, _preact.h)(
                ContactTip,
