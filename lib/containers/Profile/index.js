...
var Profile = function (_Component) {
    ...
    function Profile(props) {
        ...
        _this.saveChanges = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    Profile.prototype.componentDidMount = function componentDidMount() {
        var user = this.props.user,
            languages = Object.entries(this.props.languages).map(function (_ref2) {
            var key = _ref2[0],
                value = _ref2[1];
            ...
            (0, _preact.h)(
                ...
                (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: lockdown, value: this.state.first_name, onChange: function onChange(_ref3) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: lockdown, value: this.state.last_name, onChange: function onChange(_ref4) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: true, value: this.state.email, onChange: function onChange(_ref5) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: true, value: this.state.company, onChange: function onChange(_ref6) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_index2.default, { disabled: lockdown, value: this.state.birthdate, onChange: function onChange(_ref7) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_Dropdown2.default, { disabled: lockdown, options: this.state.languages, onChange: function onChange(_ref8) {
                ...
                (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: lockdown, type: 'password', value: this.state.old_password, onChange: function onChange(_ref9) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: lockdown, type: 'password', value: this.state.new_password, onChange: function onChange(_ref10) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: lockdown, type: 'password', value: this.state.new_password2, onChange: function onChange(_ref11) {
                    ...
                    (0, _preact.h)(
                        _Button2.default,
                        { secondary: true, disabled: lockdown },
