...
})(['margin:64px auto;background-color:white;margin-top:0px;width:100%;max-width:100%;font-family:\'Montserrat\',sans-serif;']),
    data = {
    tabs: [{
        "ID": 1,
        "TITLE": "Info",
...
var Layout = function (_Component) {
    ...
    Layout.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            'div',
            null,
            (0, _preact.h)(_index2.default, { $location: $location, accountId: accountId, user: user, tabs: tabs, translations: componentProps.translations }),
            (0, _preact.h)(
                Container,
                null,
