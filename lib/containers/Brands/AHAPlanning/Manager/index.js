    ...
    function AHAManager(props) {
        ...
        _this.addHighlight = function (type) {
            return function (highlight) {
                ...
                var highlightType = type + 'Highlights',
                    update = {},
                    highlights = _this.state[highlightType],
        ...
        _this.loadAHADetails = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        ...
        _this.loadAHAManagement = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        ...
        _this.getAHADetails = function () {
            ...
            _this.setState({ loading: true }, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
                var _this$props$events, getHighlighterFeedback, loadEmailTemplate, details, highlights, templates;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            ...
                            case 3:
                                ...
                                if (details.aha.aha_sending_status === SENDING_STATES.ACTIVE || details.aha.aha_sending_status === SENDING_STATES.INACTIVE) {
                                    notReady = true;
        ...
        _this.state = (_this$state3 = {
            ...
            all_journalists: {},
            brand: {}
        }, _this$state3['feedback'] = {}, _this$state3.formentry = {}, _this$state3.sending = {}, _this$state3.templates = {}, _this$state3.templateUrl = {}, _this$state3.flags = {
            outOfSync: false,
            notReady: false,
            feedbackAlreadyGiven: false
        }, _this$state3.cancelReason = '', _this$state3.cancelAhaModal = false, _this$state3.submitAhaModal = false, _this$state3.approveAhaModal = false, _this$state3);
        return _this;
    }
    ...
    AHAManager.prototype.render = function render() {
        ...
        return loading ? (0, _preact.h)('div', null) : (0, _preact.h)(
            ...
            (0, _preact.h)(
                'div',
                null,
                Object.entries(flags).map(function (_ref13) {
                    var key = _ref13[0],
                        value = _ref13[1];
            ...
            (0, _preact.h)(
                ...
                (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(FeedbackSection, { onChange: function onChange(val) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(
                            JournalistContent,
                            null,
                            (0, _preact.h)(_Annotator2.default, { text: formentry.aha_form_entrys_emailbodytekst_raw, readOnly: false, highlights: emailHighlights, addHighlight: this.addHighlight('email'), deleteHighlight: this.deleteHighlight('email'), updateHighlight: this.updateHighlight('email') })
                        ),
                        (0, _preact.h)(FeedbackSection, { onChange: function onChange(val) {
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(
                            JournalistContent,
                            null,
                            (0, _preact.h)(_Annotator2.default, { text: formentry.aha_form_entrys_lpbodytekst_raw, readOnly: false, highlights: lpHighlights, addHighlight: this.addHighlight('lp'), deleteHighlight: this.deleteHighlight('lp'), updateHighlight: this.updateHighlight('lp') })
                        ),
                        (0, _preact.h)(FeedbackSection, { onChange: function onChange(val) {
            ...
            (0, _preact.h)(CancelAHAModal, {
                ...
                changeReason: function changeReason(_ref14) {
...
function FeedbackSection(props) {
    ...
    return (0, _preact.h)(
        ...
        (0, _preact.h)(_index2.default, { value: value, onChange: function onChange(_ref15) {
...
var EmailTemplate = function (_Component2) {
    ...
    EmailTemplate.prototype.render = function render() {
        ...
        return (0, _preact.h)(IFrameEl, { onLoad: this.onLoad, ref: function ref(_ref16) {
                return _this7.frame = _ref16;
            }, srcdoc: iframeContent, sandbox: 'allow-same-origin' });
    };
