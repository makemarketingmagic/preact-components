...
})(['background-color:rgba(136,165,173,0.2);mix-blend-mode:normal;width:256px;height:256px;position:relative;margin-bottom:32px;display:flex;align-items:center;justify-content:center;&::after{content:\'\';height:256px;width:256px;position:absolute;left:0;top:0;background-color:rgba(136,165,173,0.2);mix-blend-mode:normal;}']),
...
var Info = function (_Component) {
    ...
    function Info(props) {
        ...
        _this.onDrop = function (files) {
            var uploadFile = _this.props.uploadFile;
    ...
    Info.prototype.render = function render() {
        var _props2 = this.props,
            getLanguage = _props2.getLanguage,
            _props2$translations = _props2.translations,
            translations = _props2$translations === undefined ? { getTranslation: function getTranslation(label, fallback) {
                return fallback;
            } } : _props2$translations;
        ...
        return (0, _preact.h)(
            ...
            (0, _preact.h)(
                LeftSide,
                null,
                (0, _preact.h)(_preactHelmet2.default, { title: translations.getLL('INFO', 'Info') + ' | WOO' }),
                (0, _preact.h)(
                    ImageContainer,
                    null,
                    (0, _preact.h)(
                        'div',
                        null,
                        (0, _preact.h)(BrandImage, { src: this.state.info.brand_logo_image })
                    )
                ),
                (0, _preact.h)(
                    _index4.default,
            ...
            (0, _preact.h)(
                ...
                (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                        ...
                        (0, _preact.h)(_SingleLineTextInput2.default, { disabled: true, value: getLanguage() })
                    )
                )
            )
        );
