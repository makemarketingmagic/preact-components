...
var ExpandingSection = function (_Component) {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _this.setState({ opportunityDetails: null }, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                                    ...
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            ...
                                            case 3:
                                                ...
                                                _this.setState({ opportunityDetails: opportunityDetails });
    ...
    ExpandingSection.prototype.renderDropdown = function renderDropdown() {
        ...
        return (0, _preact.h)(_Dropdown2.default, { options: this.state.labels, onChange: function onChange(val) {
                updateLabelAndStatus(_extends({}, _this3.props.data, { label: val.value }));
