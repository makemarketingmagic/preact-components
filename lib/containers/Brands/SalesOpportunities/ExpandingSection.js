...
var ExpandingSection = function (_Component) {
    ...
    ExpandingSection.prototype.render = function render() {
        var data = _extends({}, this.props.events.getData(), this.props.data);
        console.debug(data);
        return (0, _preact.h)(
            Container,
            null,
            (0, _preact.h)(
                ...
                data.contacts.map(function (val) {
                    return (0, _preact.h)(
                        Visit,
                        null,
                        val
            ...
            (0, _preact.h)(
                ButtonsContainer,
                null,
                (0, _preact.h)(_Dropdown2.default, { options: [{ name: 'test', text: 'Testing 1 2 3 4 5 6 ' }], placeholder: 'No Label' }),
