...
var SalesOpportunities = function (_Component) {
    ...
    function SalesOpportunities(props) {
        ...
        _this.getFiveAround = function (array, index) {
            if (array.length <= 5) return array;else if (array[index - 2] && array[index + 2]) {
    ...
    SalesOpportunities.prototype.renderPages = function renderPages() {
        ...
        pages.push.apply(pages, pageNumbers);
        pages.push((0, _preact.h)(
            PageNumber,
            { current: false, onClick: function onClick() {
                    return _this4.changePage(currentPage + 1);
    ...
    SalesOpportunities.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            'div',
            null,
            (0, _preact.h)(_preactHelmet2.default, { title: translations.getLL('SALES_OPPORTUNITIES', 'Sales Opportunities') + ' | WOO' }),
            (0, _preact.h)(
                TitleArea,
                null,
                (0, _preact.h)(
