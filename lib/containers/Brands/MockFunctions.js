...
var labels = [{ data: -1, label: 'Geen label', selected: true }, { data: 1, label: 'Klant', selected: true }, { data: 7, label: 'Voormalig klant', selected: true }, { data: 4, label: 'Prospect met offerte', selected: true }, { data: 2, label: 'Prospect mee in gesprek', selected: true }, { data: 3, label: 'Prospect in de doelgroep', selected: true }, { data: 5, label: 'Prospect verloren', selected: true }, { data: 0, label: 'Vrienden & collega\'s', selected: true }, { data: 6, label: 'Niet interessant', selected: true }, { data: 8, label: 'Concurrent', selected: true }];
