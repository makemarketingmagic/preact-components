...
var Notes = function (_Component) {
    ...
    function Notes(props) {
        ...
        _this.onSelect = function (id) {
            if (id >= -1 && id !== _this.state.selected) {
                        ...
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                _this.setState({ loading: true }, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
                                    var _this$props$events, _this$props$events$up, updateNote, _this$props$events$cr, createNote, selectedNote;

                                    return regeneratorRuntime.wrap(function _callee5$(_context5) {
                                        while (1) {
                                            switch (_context5.prev = _context5.next) {
                                                case 0:
                                                    _this$props$events = _this.props.events, _this$props$events$up = _this$props$events.updateNote, updateNote = _this$props$events$up === undefined ? null : _this$props$events$up, _this$props$events$cr = _this$props$events.createNote, createNote = _this$props$events$cr === undefined ? null : _this$props$events$cr;
        ...
        _this.addNote = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            var notes;
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            ...
                            _this.setState({ notes: notes }, function () {
                                _this.reloadFilters();
                                _this.onSelect(-1);
                            });
    ...
    Notes.prototype.render = function render() {
        ...
        return (0, _preact.h)(
            'div',
            null,
            (0, _preact.h)(_preactHelmet2.default, { title: translations.getLL('NOTES', 'Notes') + ' | WOO' }),
            (0, _preact.h)(
                TitleArea,
                null,
                (0, _preact.h)(
            ...
            (0, _preact.h)(_Table2.default, {
                ...
                renderers: {
                    innerContent: function innerContent(value) {
                        return _this3.stripHtmlTags(value);
                    },
